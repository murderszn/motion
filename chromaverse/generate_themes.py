    ...
    <style>
        ...
        *::after {{
        ...
        .banner-title {{
            ...
            text-transform: uppercase;
            margin: var(--sp-2) 0;
            -webkit-text-stroke: 0.035em rgba(228, 234, 244, 0.95);
            paint-order: stroke fill;
            text-shadow:
                -0.02em -0.02em 0 rgba(255, 255, 255, 0.55),
                0.02em 0.02em 0 rgba(72, 82, 102, 0.6),
                0 0 0.35em rgba(200, 212, 235, 0.35),
                0 0.06em 0.2em rgba(0, 0, 0, 0.45);
        }}

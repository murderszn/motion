...
<head>
    ...
    <style>
        ...
        *::after {{
        ...
        .banner-title span {{
            background: linear-gradient(135deg, #FF3366, #FF6633, #FFDD00, #00CC44, #0088FF, #6633FF);
    ...
    <div class="scroll-container">
        ...
        <section class="chromaverse-banner" id="banner-section">
            ...
            <div class="banner-content">
                ...
                <h1 class="banner-title" style="color: #ffffff;">CHROMA<span>VERSE</span></h1>
                <p class="banner-subtitle">The Ultimate Color Palette & Design System Studio</p>
                The Ultimate Color Palette & Design System Studio</p>
                <p class="banner-desc">65 hand-crafted color palettes, 130 responsive light/dark surface tokens, and custom font pairings. Engineered for extreme legibility, high contrast, and premium aesthetic experience.</p>
